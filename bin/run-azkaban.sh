...
# 
# To use this script
# run it as root - it will switch to the specified user or rex user can run it without sudo
...
sleep 5
if [ $(id -u) = "0" ] && [ ${USER} != "rex" ]; then
        echo
        echo "AZKABAN startup is not allowed to run by ${txtred}root/superuser${txtrst}, please run as ${txtgrn}rex${txtrst} user"
        echo
    exit 1
fi
...
status() {
	...
	echo
		...
		source ${AZ_HOME}/conf/az_8081.cfg
                echo "==================================================================================================================================================" ; echo -e "${txtred}\t\t\t\t\t\t\t\tAzkaban instance - 01${txtrst}" ; echo "==================================================================================================================================================";echo -e "${txtgrn}|USER|\t|PID|\t|JOB_DIR|\t\t\t\t\t|LOG_DIR|\t\t\t\t\t|ZK_HOST|\t\t|ENV_ID|${txtrst}" ; echo -e "${txtble}|rex|\t|${pid_1}|\t|${JOB_DIR}|\t|${LOG_DIR}|\t|${REX_ZOOKEEPER_HOSTS}|\t|${REX_CONFIG_ENVIRONMENT}|${txtrst}"
		...
		echo "==================================================================================================================================================" ; echo -e "${txtred}\t\t\t\t\t\t\t\tAzkaban instance - 02${txtrst}" ; echo "==================================================================================================================================================";echo -e "${txtgrn}|USER|\t|PID|\t|JOB_DIR|\t\t\t\t\t|LOG_DIR|\t\t\t\t\t|ZK_HOST|\t\t|ENV_ID|${txtrst}" ; echo -e "${txtble}|rex|\t|${pid_2}|\t|${JOB_DIR}|\t|${LOG_DIR}|\t|${REX_ZOOKEEPER_HOSTS}|\t|${REX_CONFIG_ENVIRONMENT}|${txtrst}"
		...
		echo "==================================================================================================================================================" ; echo -e "${txtred}\t\t\t\t\t\t\t\tAzkaban instance - 03${txtrst}" ; echo "==================================================================================================================================================";echo -e "${txtgrn}|USER|\t|PID|\t|JOB_DIR|\t\t\t\t\t|LOG_DIR|\t\t\t\t\t|ZK_HOST|\t\t|ENV_ID|${txtrst}" ; echo -e "${txtble}|rex|\t|${pid_3}|\t|${JOB_DIR}|\t|${LOG_DIR}|\t|${REX_ZOOKEEPER_HOSTS}|\t|${REX_CONFIG_ENVIRONMENT}|${txtrst}"
